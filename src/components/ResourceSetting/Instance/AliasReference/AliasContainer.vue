  ...
  <div class="w3-col m9 w3-animate-opacity">
    ...
    <div v-if="showMode" class="w3-small">
        <div class="w3-container w3-card-4 w3-signal-white w3-round w3-margin">
            <p>
                <div>
                    <span><img src="/src/assets/images/resource_setter/entity.png" alt="Business Entity" class="w3-margin-right w3-left w3-hide-small" style="height32px;width:32px"></span>
                    <span>
              ...
              <div>
                <div class="w3-responsive w3-card w3-round">
                    <table class="w3-table-all">
                        <tr class="w3-teal">
                            <th class="w3-center w3-btn w3-hover-none" width="30%" title="Order by Entity Name" @click="applyOrder('busentityname')">
                                Name
                                &nbsp;&nbsp;
                ...
                <div id="entityContainer" class="w3-responsive w3-card w3-round">
                    <table id="entityTable" class="w3-table-all w3-left">
                        ...
                        <tr :id="content.busentityuid" :key="content.busentityuid" class="w3-hover-blue-grey w3-hover-opacity" style="cursor: pointer" 
                                @click="clickOnEntityRecord(content.busentityuid, index)" v-for="(content, index) in allEntityObjs">
                            <td width="30%">
                                <span>{{ content.busentityname }}</span>
                            </td>
                            <td width="48%">
