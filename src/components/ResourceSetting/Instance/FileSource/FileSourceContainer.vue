<template>
    <div>
        ...
        <file-source-category-edit-window v-if="editCategoryWindowAlive" :windowAlive="editCategoryWindowAlive"
                                          ...
                                          :urlOp="operation"></file-source-category-edit-window>
        ...
        <file-source-edit-window v-if="editFileSourceWindowAlive" :windowAlive="editFileSourceWindowAlive"
                                 ...
                                 :urlOp="operation"></file-source-edit-window>
                    ...
                    <div class="w3-container w3-card-4 w3-signal-white w3-round">
                        <p>
                            <div class="w3-row w3-border w3-round w3-padding">
                                <span>
                                    <img src="src/assets/images/resource_setter/filesource_category.png" alt="File Source Category" class="w3-margin-right w3-left w3-hide-small" style="height26px;width:26px">
                                </span>
                                        ...
                                        <tr :id="content.fscategoryuid" :key="content.fscategoryuid" class="w3-hover-blue-grey w3-hover-opacity" style="cursor: pointer"
                                            ...
                                            <td :width="gridWidth[2]">
                                                <span :title="content.description">
                                                    {{ content.description.length > 25 ? content.description.substr(0, 25) + '...' : content.description }}
                                                </span>
                                            </td>
            ...
            <div class="w3-small">
                <div class="w3-container w3-card-4 w3-signal-white w3-round w3-margin">
                    <div class="w3-panel w3-row w3-border w3-round w3-padding">
                        <span>
                            <img src="src/assets/images/resource_setter/filesource.png" class="w3-margin-right w3-left w3-hide-small"
                        ...
                        <div id="filesourceContainer" class="w3-responsive w3-card w3-round">
                            <table id="filesourceTable" class="w3-table-all">
                                ...
                                <tr v-else :id="content.filesourceuid" :key="content.filesourceuid" class="w3-hover-blue-grey w3-hover-opacity" style="cursor: pointer"
                                    ...
                                    <td :width="gridWidth[1]">
                                        <span v-if="selectedCategoryRecord && selectedCategoryRecord.fscategoryname" style="text-decoration:underline;" 
                                              @click.stop="clickOnFileSourceName(content.filesourceuid, index)">
                                        ...
                                        <span v-else style="text-decoration:underline;" @click.stop="clickOnFileSourceName(content.filesourceuid, index)">
        ...
        methods: {
            ...
            */
            ...
            clickOnFileSourceName(id, index) {
                ...
                this.changeFileSourceWindowStatus('edit')
            },
            /*
