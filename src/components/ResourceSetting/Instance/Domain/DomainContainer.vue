<template>
    <div>
        ...
        <domain-edit-window v-if="domainWindowAlive" :windowAlive="domainWindowAlive"
                            ...
                            :urlOp="operation"></domain-edit-window>
        ...
        <confirm-delete-window :windowAlive="deleteWindowAlive"
                               ...
                               @confirmDelete="deleteDomain"></confirm-delete-window>
                ...
                <div class="w3-col m12">
                    <div class="w3-container w3-card-4 w3-signal-white w3-round">
                        <div class="w3-panel w3-border w3-round w3-padding">
                            <span>
                                <img src="src/assets/images/resource_setter/domain.png" class="w3-margin-right w3-left w3-hide-small"
                            ...
                            <i class="w3-right fa fa-plus w3-button" :title="$t('Container.Func.Add')" aria-hidden="true" @click="changeDomainWindowStatus('add')"></i>
                                ...
                                <div class="w3-responsive w3-card w3-round">
                                    <table class="w3-table-all">
                                        <tr class="w3-teal">
                                            ...
                                            <th class="w3-btn w3-hover-none" :width="gridWidth[1]" title="Order by Domain Name" @click="applyOrder('name')">
                                    ...
                                    <table id="domainTable" class="w3-table-all w3-left">
                                        ...
                                        <tr v-else :id="content.domainuid" :key="content.domainuid" class="w3-hover-blue-grey w3-hover-opacity" style="cursor: pointer"
                                            ...
                                            <td id="barsTD" :width="gridWidth[0]">
                                                <div class="w3-dropdown-hover w3-blue-grey" style="display:none;position:absolute">
                                                    ...
                                                    <div class="w3-dropdown-content w3-bar-block w3-border w3-card-4">
                                                        <button class="w3-bar-item w3-button w3-padding-small" @click.stop="changeDomainWindowStatus('copy')"> {{ $t('Container.Func.Copy') }}</button>
                                            ...
                                            <td :width="gridWidth[1]">
                                                <span style="text-decoration:underline;" @click.stop="clickOnDomainRecordName(content.domainuid, index)">
                                                    {{ content.name }}
                                                </span>
                                            </td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            clickOnDomainRecordName(id, index) {
                let tr = document.getElementById(id)
                ...
                this.changeDomainWindowStatus('edit')
            },
            ...
            getDomains(e) {
                if (!PermissionTable.root && !PermissionTable.admin) {
                    if (!PermissionTable.domain_func || !PermissionTable.domain_func.view)
                        return
                }
