            ...
            <div v-else>
                <div v-show="tabsFlag[0]">
                    <div class="w3-responsive w3-card w3-round">
                        <table class="w3-table-all w3-small">
                            <tr class="w3-teal">
                                <th class="w3-center" width="50%" style="padding-top:12px;padding-bottom:12px">Variable Name</th>
                                <th class="w3-center" width="40%" style="padding-top:12px;padding-bottom:12px">Variable Value</th>
                ...
                <div v-show="tabsFlag[1]">
                    <div class="w3-responsive w3-card w3-round">
                        <table class="w3-table-all w3-small">
                            <tr class="w3-teal">
                                <th class="w3-center" width="50%" style="padding-top:12px;padding-bottom:12px">Resource Name</th>
                                <th class="w3-center" width="40%" style="padding-top:12px;padding-bottom:12px">Resource Value</th>
                                <th class="w3-center" width="10%" style="padding-top:7px;padding-bottom:7px">
