<template>
    <div>
        ...
        <agent-edit-window v-if="agentWindowAlive" :windowAlive="agentWindowAlive"
                           ...
                           :content="agentRecord"
                           :urlOp="operation"></agent-edit-window>
                ...
                <div class="w3-col m12">
                    <div class="w3-container w3-card-4 w3-signal-white w3-round">
                        <div class="w3-panel w3-border w3-round w3-padding">
                            <span>
                                <img src="src/assets/images/resource_setter/Agent_128.png" class="w3-margin-right w3-left w3-hide-small"
                                ...
                                <div class="w3-responsive w3-card w3-round">
                                    <table class="w3-table-all">
                                        <tr class="w3-teal">
                                            ...
                                            <th class="w3-btn w3-hover-none" :width="gridWidth[1]" title="Order by Agent Name" @click="applyOrder('agentname')">
                                            ...
                                            <th class="w3-btn w3-hover-none" :width="gridWidth[2]" title="Order by IP" @click="applyOrder('host')">
                                                {{ $t('Container.Grid.IPAddress') }}
                                                &nbsp;
                                    ...
                                    <table id="agentTable" class="w3-table-all w3-left">
                                        ...
                                        <tr v-else :id="content.agentuid" :key="content.agentuid" class="w3-hover-blue-grey w3-hover-opacity" style="cursor: pointer"
                                            ...
                                            <td id="barsTD" :width="gridWidth[0]">
                                                <div class="w3-dropdown-hover w3-blue-grey" style="display:none;position:absolute">
                                                    ...
                                                    <div class="w3-dropdown-content w3-bar-block w3-border w3-card-4">
                                                        <button class="w3-bar-item w3-button w3-padding-small" @click.stop="changeAgentWindowStatus('copy')"> {{ $t('Container.Func.Copy') }}</button>
                                            ...
                                            <td :width="gridWidth[1]">
                                                <span style="text-decoration:underline;" @click.stop="clickOnAgentRecordName(content.agentuid, index)">
                                                    {{ content.agentname }}
                                                </span>
                                            </td>
