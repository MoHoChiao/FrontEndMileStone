            ...
            <div class="w3-col m12">
                <div class="w3-responsive w3-card w3-round">
                    <table class="w3-table-all">
                        <tr class="w3-teal">
                            <th class="w3-center" width="10%" style="padding-top:12px;padding-bottom:12px">Seq</th>
                            <th class="w3-center" width="40%" style="padding-top:12px;padding-bottom:12px">Start Time</th>
                            <th class="w3-center" width="40%" style="padding-top:12px;padding-bottom:12px">End Time</th>
