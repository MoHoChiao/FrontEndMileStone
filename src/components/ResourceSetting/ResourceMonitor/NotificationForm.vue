    ...
    <div class="w3-small">
        <div class="w3-row-padding w3-section">
            <div class="w3-row w3-section">
                Notification Type :
                <input type="radio" value="email" v-model="notify_type">
                <label>Email</label>
                <input type="radio" value="sms" v-model="notify_type">
                <label>SMS</label>
                <input type="radio" value="both" v-model="notify_type">
                <label>Both</label>
                {{notify_type}}
            </div>
            <div class="w3-half">
                <div class="w3-responsive w3-card w3-round">
                    <table class="w3-table-all">
                        <tr class="w3-teal">
                            <th width="77%">User Name (User ID)</th>
                            <th width="15%" class="w3-center">Activate</th>
                            <th width="8%" class="w3-center" style="cursor:pointer">
                                <i class="fa fa-plus-square w3-bar" title="Add User" aria-hidden="true" @click="addUser"></i>
                            </th>
                        </tr>
                    </table>
                </div>
                <div class="w3-responsive w3-card w3-round" style="overflow:auto;height:150px">
                    <table class="w3-table-all">
                        <tr :key="list_info.destinationuid" v-for="(list_info, index) in new_content.userlist">
                            <td width="77%">
                                <span>
                                    <select class="w3-select w3-border" v-model="list_info.destinationuid" style="padding:0px" @change="changeUser(list_info.destinationuid,index)">
                            ...
                            <td width="8%" class="w3-center">
                                <i class="fa fa-minus-circle w3-bar" style="padding-top:8px;cursor:pointer"
                                   title="Delete" aria-hidden="true" @click="delUser(index)"></i>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="w3-half">
                <div class="w3-responsive w3-card w3-round">
                    <table class="w3-table-all">
                        <tr class="w3-teal">
                            <th width="77%">User Group Name</th>
                            <th class="w3-center" width="15%">Activate</th>
                            <th class="w3-center" width="8%" style="cursor: pointer">
                                <i class="fa fa-plus-square w3-bar" title="Add User" aria-hidden="true" @click="addGroup"></i>
                            </th>
                        </tr>
                    </table>
                </div>
                <div class="w3-responsive w3-card w3-round" style="overflow:auto;height:150px">
                    <table class="w3-table-all">
                        <tr :key="list_info.destinationuid" v-for="(list_info, index) in new_content.grouplist">
                            <td class="w3-center" width="77%">
                                <span>
                                    <select class="w3-select w3-border" v-model="list_info.destinationuid" style="padding:0px" @change="changeGroup(list_info.destinationuid,index)">
                            ...
                            <td class="w3-center" width="8%">
                                <i class="fa fa-minus-circle w3-bar" style="padding-top:8px;cursor:pointer"
                                   title="Delete" aria-hidden="true" @click="delGroup(index)"></i>
                            </td>
                        </tr>
                    </table>
                </div>
