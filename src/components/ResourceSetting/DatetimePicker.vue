<template>
  <div class="cov-vue-date" :class="option.wrapperClass ? option.wrapperClass : {}">
    <div v-if="inputMode" class="datepickbox">
    ...
    <div class="datepicker-overlay" v-if="showInfo.check || !inputMode" @click="dismiss($event)" v-bind:style="{'background' : option.overlayOpacity? 'rgba(0,0,0,'+option.overlayOpacity+')' : 'rgba(0,0,0,0.5)'}">
      <div class="cov-date-body w3-blue-grey">
