<template>
    <modal-window v-if="this.windowAlive" :window-title="windowTitle" :window-bg-color="windowBgColor" @closeModalWindow="cancel">
        <rule-form v-if="urlOp === 'add'" slot="content" ref="frequencyForm" @save="save"></rule-form>
        <rule-form v-else slot="content" ref="frequencyForm" :content="content" :urlOp="urlOp" @save="save"></rule-form>
        <div slot="footer">
