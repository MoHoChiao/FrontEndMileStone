<template>
    <div class="w3-small">
        <div class="w3-row w3-section">
            ...
            <div class="w3-col m6">
                <input name="name" :class="[inputClassList.common, errors.has('name')? inputClassList.invalid: '']"
                       v-validate="'required'" v-model="new_content.name" type="text" maxlength="128" placeholder="" autocomplete="off">
            </div>
        </div>
        <div class="w3-row w3-section">
            <div class="w3-col m2" style="padding:8px 4px 8px 0px">
            ...
            <div class="w3-col m9">
                <input name="url" :class="[inputClassList.common, errors.has('url')? inputClassList.invalid: '']"
                       v-validate="'required'" v-model="new_content.url" type="text" maxlength="1024" placeholder="" autocomplete="off">
            </div>
        </div>
