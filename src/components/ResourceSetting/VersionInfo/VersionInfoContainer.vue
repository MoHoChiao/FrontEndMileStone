                            ...
                            <div class="w3-row">
                                <span class="w3-col m6">
                                    <input class="w3-small w3-input w3-border w3-border w3-left w3-col m9" type="text" maxlength="32" v-model="inputStr"
                                           placeholder="Name" style="height:31px" @keyup.enter="searchBy">
    ...
    export default {
        ...
        computed: {
            ...
            filterData: function () {
                ...
                return _.filter(this.dataObjs, obj => { return reg.test(obj.name); });
            },
            dataObjs: function () {
                if (this.tabsFlag[0]) {
        ...
        methods: {
            ...
            exportCSV() {
                ...
                let items = this.jcsServerV;
                items = items.concat(this.disServerV);
