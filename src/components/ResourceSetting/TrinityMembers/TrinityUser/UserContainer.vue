  ...
  <div class="w3-col m9 w3-animate-opacity">
    ...
    <div v-if="showMode" class="w3-small">
        <div class="w3-container w3-card-4 w3-signal-white w3-round w3-margin">
            <p>
                <div>
                    <span><img src="/src/assets/images/resource_setter/User.png" alt="User Group" class="w3-margin-right w3-left w3-hide-small" style="height32px;width:32px"></span>
                    <span>
                ...
                <div>
                    <div class="w3-responsive w3-card w3-round">
                        <table class="w3-table-all">
                            <tr class="w3-teal">
                                <th class="w3-center w3-btn w3-hover-none" width="20%" title="Order by User Name" @click="applyOrder('username')">
                                    Name
                                    &nbsp;&nbsp;
                                ...
                                <th class="w3-center w3-btn w3-hover-none" width="20%" title="Order by User ID" @click="applyOrder('userid')">
                                    ID
                                    &nbsp;&nbsp;
                    ...
                    <div id="userContainer" class="w3-responsive w3-card w3-round">
                        <table id="userTable" class="w3-table-all w3-left">
                            ...
                            <template v-else v-for="(content, index) in allUserObjs">
                                <tr v-if="content.userid.trim() !== 'root'" :id="content.useruid" :key="content.useruid" class="w3-hover-blue-grey w3-hover-opacity" style="cursor: pointer" 
