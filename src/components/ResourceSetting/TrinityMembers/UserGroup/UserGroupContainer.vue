<template>
    <div>
        ...
        <user-group-edit-window v-if="groupWindowAlive" :windowAlive="groupWindowAlive"
                                ...
                                :content="groupRecord"
                                :urlOp="operation"></user-group-edit-window>
        ...
        <user-group-member-window v-if="applyWindowAlive" :windowAlive="applyWindowAlive"
                                  ...
                                  @closeApply="closeMemberWindow"></user-group-member-window>
                ...
                <div class="w3-col m12">
                    <div class="w3-container w3-card-4 w3-signal-white w3-round">
                        <div class="w3-panel w3-border w3-round w3-padding">
                            ...
                            <i class="w3-right fa fa-plus w3-button" :title="$t('Container.Func.Add')" aria-hidden="true" @click="changeGroupWindowStatus('add')"></i>
                                ...
                                <div class="w3-responsive w3-card w3-round">
                                    <table class="w3-table-all">
                                        <tr class="w3-teal">
                                            ...
                                            <th class="w3-btn w3-hover-none" :width="gridWidth[1]" title="Order by Group Name" @click="applyOrder('groupname')">
                                            ...
                                            <th class="ssw3-btn w3-hover-none" :width="gridWidth[3]" title="Order by Update Time" @click="applyOrder('lastupdatetime')">
                                    ...
                                    <table id="groupTable" class="w3-table-all w3-left">
                                        ...
                                        <tr v-else :id="content.groupuid" :key="content.groupuid" class="w3-hover-blue-grey w3-hover-opacity" style="cursor: pointer"
                                            ...
                                            <td id="barsTD" :width="gridWidth[0]">
                                                <div class="w3-dropdown-hover w3-blue-grey" style="display:none;position:absolute">
                                                    ...
                                                    <div class="w3-dropdown-content w3-bar-block w3-border w3-card-4">
                                                        <button class="w3-bar-item w3-button w3-padding-small" @click.stop="openMemberWindow"> {{ $t('Container.Func.Member') }}</button>
                                            ...
                                            <td :width="gridWidth[1]">
                                                <span style="text-decoration:underline;" @click.stop="clickOnGroupRecordName(content.groupuid, index)">
                                                    {{ content.groupname }}
                                                </span>
                                            </td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            clickOnGroupRecordName(id, index) {
                let tr = document.getElementById(id)
                ...
                this.changeGroupWindowStatus('edit')
            },
